<template>
  <footer
    class="bg-gray-950 text-gray-500 text-sm border-t border-white/[0.06] mt-auto"
  >
    <div class="max-w-7xl mx-auto px-4 pt-10 pb-6">
      <!-- Top -->
      <div
        class="flex flex-col md:flex-row items-start md:items-start justify-between gap-8 mb-8"
      >
        <!-- Brand -->
        <div class="max-w-xs">
          ...
          <div>
            ...
            <div class="flex flex-col gap-2 text-xs">
              <NuxtLink to="/" class="hover:text-white transition-colors"
                >Home</NuxtLink
              >
              <NuxtLink to="/shop" class="hover:text-white transition-colors"
                >Shop</NuxtLink
              >
      ...
      <!-- Bottom bar -->
      <div
        class="border-t border-white/[0.05] pt-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3"
      >
        <p class="text-xs text-gray-700 leading-relaxed max-w-lg">
          <strong class="text-gray-600">Affiliate Disclosure:</strong>
          WinRose participates in affiliate programs and earns commissions on
          qualifying purchases at no extra cost to you.
          <NuxtLink
            to="/disclosure"
            class="text-gray-500 hover:text-white underline ml-1 transition-colors"
            >Learn more</NuxtLink
          >
        </p>
        <p class="text-xs text-gray-700 flex-shrink-0">
          © 2026 WinRose. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
