<template>
  <div class="max-w-2xl mx-auto px-4 py-12">
    ...
    <p class="text-gray-500 mb-10">
      Questions, feedback, or data correction requests — we read every message.
    </p>
    ...
    <div
      class="mt-12 pt-8 border-t border-gray-200 text-sm text-gray-500 space-y-1"
    >
      <p>
        <strong class="text-gray-700">Response time:</strong> Within 2 business
        days
      </p>
      <p>
        <strong class="text-gray-700">Affiliate inquiries:</strong> Please
        include your platform/site URL
      </p>
      <p>
        <strong class="text-gray-700">Data removal requests:</strong> Reference
        our
  ...
  meta: [
    {
      name: "description",
      content:
        "Contact WinRose for product data corrections, privacy requests, or general questions about our price comparison platform.",
    },
  ],
});
</script>
